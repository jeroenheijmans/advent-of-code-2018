...
namespace AdventOfCode2018
{
    public class Day01
    {
        ...
        public long Solve2(long[] input)
        {
            var fqs = new List<long>();
            long result = 0;
            long idx = 0;

            while (!fqs.Contains(result))
            {
                fqs.Add(result);
                result += input[idx];
                idx++;

...
";
        ...
        private int HandrolledProgram(long initForRegister0, int maxLoops = 1)
        {
            ...
            while (true)
            {
                ...
                reg4 = reg5 | 65536; // 0b0000_0000_0000_0001_0000_0000_0000_0000
                reg5 = 15466939;

                reg5 = reg5 + (reg4 & 0b0000_0000_0000_0000_0000_0000_1111_1111);
                reg5 = reg5 & 16777215; // 0b0000_0000_1111_1111_1111_1111_1111_1111
                reg5 = reg5 * 65899;
                reg5 = reg5 & 16777215; // 0b0000_0000_1111_1111_1111_1111_1111_1111
